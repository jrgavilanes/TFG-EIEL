...
EIEL_TABLE_NAME = "parque"
ORDER_FIELD = "orden_parq"
NOMECALLES_TABLES_NAMES = [
    "parques",
    "parquesocio"
]
TIPO_EQUIPAMIENTO = "PJ"


class ParkCreateRequest(BaseModel):
    fase: str
    clave: str
    prov: str
    mun: str
    ...
    s_sola: Optional[int]
    agua: Optional[str]
    saneamiento: Optional[str]
    electricidad: Optional[str]
    comedor: Optional[str]
    juegos_inf: Optional[str]
    otras: Optional[str]
...
async def update_by_gid(
    ...
    values = {
        ...
        "agua": equipment.agua,
        "saneamiento": equipment.saneamiento,
        "electricidad": equipment.electricidad,
        "comedor": equipment.comedor,
        "juegos_inf": equipment.juegos_inf,
        "otras": equipment.otras,
...
async def insert_equipment(
    ...
    equipment.orden_parq = result.get("order_field")
...
async def insert_equipment_in_db(equipment, db_postgres):
    ...
    query = sql.text(f"""
        INSERT INTO eiel.parque(
            fase, clave, prov, mun, ent, poblamiento, orden_parq, nombre, tipo_parq, titular, gestion, 
            s_cubi, s_aire, s_sola, agua, saneamiento, electricidad, comedor, juegos_inf, otras, 
    ...
    values = {
        ...
        "orden_parq": equipment.orden_parq,
        "nombre": equipment.nombre,
        "tipo_parq": equipment.tipo_parq,
        "titular": equipment.titular,
        "gestion": equipment.gestion,
