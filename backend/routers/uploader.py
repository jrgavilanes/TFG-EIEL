...
S3_BUCKET_NAME = os.getenv('S3_BUCKET_NAME', "dephi-eiel-images")
S3_REGION_NAME = os.getenv('S3_REGION_NAME', "weur")
S3_ENDPOINT_URL = os.getenv('S3_ENDPOINT_URL', "https://012d5ec525c857ce18df488f072b9538.r2.cloudflarestorage.com")
S3_ACCESS_KEY_ID = os.getenv('S3_ACCESS_KEY_ID', "125ae5b2ba43c8c85d4b1e299a593644")
S3_SECRET_ACCESS_KEY = os.getenv('S3_SECRET_ACCESS_KEY', "6b0cc94a0c66679829aaca2364bf3432ab40e0b219499367c6301eb4942a03e2")
S3_PHOTO_BASE_URL = os.getenv('S3_PHOTO_BASE_URL', "https://dephi-images.janrax.dev")
S3_PHOTO_MINIFY_BASE_URL = os.getenv('S3_PHOTO_MINIFY_BASE_URL', "https://dephi-images.janrax.dev/photos_minify")
